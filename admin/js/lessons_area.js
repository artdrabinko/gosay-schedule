;function LessonsArea(){
   ...
   this.saveLessonAction = function(component_id, callback = undefined){
      ...
      $.ajax ({
          url: "/site/admin/php/save_lesson.php",
          type: "POST",
          data: ({group_name: group_name, subgroup: this.selected_subgroup, week: this.selected_week, day: this.selected_day, time: this.selected_lesson,
   ...
   this.deleteLessonAction = function(component_id, callback = undefined){
      ...
      if (r == true) {
         ...
         $.ajax ({
            url: "/site/admin/php/delete_lesson.php",
            type: "POST",
            data: ({group_name: group_name, subgroup: this.selected_subgroup, week: this.selected_week, day: this.selected_day, time: this.selected_lesson}),
            dataType: "html",
