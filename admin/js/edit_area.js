;function EditArea(lessons_area) {
   ...
   this.ajaxSearchScheduleByGroupName = function (name_group, callback){
      ...
      $.ajax ({
         url: "/site/admin/php/get_schedule_day.php",
         type: "POST",
         data: ({name_group: name_group, subgroup: subgroup, week: week, day: day,v  key: "S_DAY"}),
         dataType: "html",
