      ...
      <div class="col-md-8 pt-4">
        ...
        <form onsubmit="return checkForm(this)" action="addLesson.php" method="POST" class="col">
          ...
          <div class="form-row">
            ...
            <div class="col-md-3 mb-2 ml-0" style="padding-left: 0px;">
              <input type="text" class="form-control" id="group_name" placeholder=" СП641" maxlength="5" required>
              <div class="invalid-feedback"></div>
            </div>

            <label id="log_text_update"class="text-success col-sm-3 col-form-label" style="display:none;"><b>Обновлено</b></label>
            <label id="log_text_succes_search" class="text-success col-sm-3 col-form-label"  style="display:none;"><b>Группа найдена!</b></label>
...
<div id="aaudioNotice" style="display:none;"></div>
  ...
  <script src="/site/admin/js/lessons_area.js" type="text/javascript"></script>
  <script src="/site/admin/js/edit_area.js" type="text/javascript"></script>
   ...
   <script type="text/javascript">
      ...
      $(document).ready( function () {
         $("#group_name").keyup( function() {
            ...
            edit_area.ajaxSearchScheduleByGroupName(group_name, function(){
      ...
      function saveLesson(component_id){
         function playSound(filename){
             document.getElementById("aaudioNotice").innerHTML='<audio autoplay="autoplay"><source src="' + filename + '.mp3" type="audio/mpeg" /><source src="' + filename + '.ogg" type="audio/ogg" /><embed hidden="true" autostart="true" loop="false" src="' + filename +'.mp3" /></audio>';
         }
